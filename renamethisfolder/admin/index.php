...
if (isset($_REQUEST['action'])) {
  foreach ($_POST as $key => $value) {
    $value = preg_match("/^(false|true)$/", $value) ? $value : "'".$value."'";
...
<title>[YACG] Yet Another Content Generator 3.0</title>
<style type="text/css">
<!--
...
<body>
<div class="container">
<h1 style="text-align:right">[YACG] Yet Another Content Generator 3.0 </h1>
