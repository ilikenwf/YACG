		...
		<div class="header">
			<div class="sf_right">
				<div id="nav">
      					...
      					<li id="current"><a href="<? domain(); ?>sitemap" title="Sitemap">Sitemap</a></li>
					</ul>
				</div>
				<div class="sf_search">
...
<? adsense('728x90_as', 'FFFFFF', 'FFFFFF', '0E4D8B', '454545', '454545'); ?>
		...
		<div class="left">
			...
			<div class="right_side" style="width:564px">
				<div class="article" style="text-align:center">
					<h2><? domain(); ?> Sitemap!</h2>
					<h3>Last update: <? echo date('l dS \of F Y'); ?></h3>
<p>The index below features our most commonly requested web sites. Send us your comments, questions and requests to include other sites in this index.</p><br />
				<div><? links('', ''); ?></div>
				</div>
